...
class Patient extends Model
{
    ...
    {
        $recentPatientsIDs = self::join("sessions", "SSHN_PTNT_ID", '=', "patients.id")->whereRaw("SSHN_DATE > DATE_SUB(NOW() , INTERVAL {$days} DAY) ")->select('DISTINCT patients.id')->get()->pluck('id');
