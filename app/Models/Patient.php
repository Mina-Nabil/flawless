...
class Patient extends Model
{
    ...
    public static function loadMissingPatients($days)
    {
        ...
        return self::join("sessions", "SSHN_PTNT_ID", '=', "patients.id")->selectRaw("Count(sessions.id) as sessionCount")->groupBy('patients.id')->whereNotIn('patients.id', $recentPatientsIDs)->get();   
    }
