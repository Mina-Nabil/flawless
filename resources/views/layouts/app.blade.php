    ...
    <div id="main-wrapper">
                    ...
                    <ul id="sidebarnav">
                        ...
                        <div class="navbar-header">
                            <a class="navbar-brand" href="{{ route('home') }}">
                                <img src="{{ asset('images/logo.png') }}" height=60px alt="homepage"
                                    class="dark-logo" />
                            </a>
                        </div>
                        @if (Auth::user()->isOwner())
                            <li class="ml-auto"> <a class="waves-effect waves-dark" href="{{ url('sessions/query') }}"
                                    aria-expanded="false"><i class="fas fa-list"></i>Sessions</a>
                        @endif
                        ...
                        @else
                            <li> <a class="waves-effect waves-dark" href="{{ url('leads') }}" aria-expanded="false"><i
                                        class="icon-people"></i>Leads</a>
                            </li>
                        @endif
                        @if (Auth::user()->isOwner())
                            <li>
                                <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)"
                                    aria-expanded="false"><i class="fas fa-newspaper"></i>Accounts</a>
                                <ul aria-expanded="false" class="collapse">
                                ...
                                <ul aria-expanded="false" class="collapse">
                                    ...
                                    <li>
                                        <a class="has-arrow waves-effect waves-dark"
                                            href="javascript:void(0)">Doctors</a>
                                        <ul aria-expanded="false" class="collapse">
                                    ...
                                    <li>
                                        <a class="has-arrow waves-effect waves-dark"
                                            href="javascript:void(0)">Patients</a>
                                        <ul aria-expanded="false" class="collapse">
                        ...
                        @elseif(Auth::user()->isDoctor())
                            <li> <a class="waves-effect waves-dark" href="{{ url('reports/doctors') }}"
                                    aria-expanded="false"><i class="fas fa-chart-bar"></i>Sessions Report</a>
                            ...
                            <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)"
                                ...
                                <ul aria-expanded="false" class="collapse">
                                    @if (Auth::user()->isOwner())
                                        <li>
                                            <a class="has-arrow waves-effect waves-dark"
                                                href="javascript:void(0)">Flawless Services</a>
                                            <ul aria-expanded="false" class="collapse">
                                        ...
                                        <li>
                                            <a class="has-arrow waves-effect waves-dark"
                                                href="javascript:void(0)">Locations & Staff</a>
                                            <ul aria-expanded="false" class="collapse">
                                                <li><a href="{{ url('branches/home') }}">Branches</a></li>
                                                <li><a href="{{ url('rooms') }}">Rooms</a></li>
                                                <li><a href="{{ url('availabilities') }}">Doctors Availability</a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li>
                                            <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)">App
                                                Users</a>
                                            <ul aria-expanded="false" class="collapse">
                        ...
                        <li class="ml-auto" style="width: 320px">
                            <form class="app-search d-none d-md-block d-lg-block" action="{{ $searchURL }}"
                                ...
                                <input type="text" name=searchVal class="form-control"
                                    placeholder="Find patients by their Name or Mobile #">
                            </form>
                        </li>
                        ...
                        <li class="ml-auto  ">
                            <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)"
                                ...
                                @if (isset(Auth::user()->DASH_IMGE))
                                    <img src="{{ asset('storage/' . Auth::user()->DASH_IMGE) }} " class="img-circle"
                                        alt="user-img" style="height: 25px; width: 25px">
                                @else
                                    <img src="{{ asset('assets/images/users/def-user.png') }} " class="img-circle"
                                        alt="user-img" style="height: 25px; width: 25px">
                                @endif
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    ...
                    <div class="col-md-4 align-self-center">
                        <div class=row>
                            ...
                            <h4 class="text-themecolor m-10" style="font-family: 'Signika' ; font-size:33px">
                                {{ $title }}</h4>
                        </div>
                    </div>
                    <div class="col-md-8 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            @if (Auth::user()->isMultiBranch())
                                ...
                                <select class="select form-control" style="width:fit-content"
                                    onchange="changeBranch()" id=universalBranch>
                                    <option value=0 {{ 0 == session('branch') ? 'selected' : '' }}>All</option>
                                    @foreach ($branches as $branch)
                                        <option value="{{ $branch->id }}"
                                            {{ $branch->id == session('branch') ? 'selected' : '' }}>
                            ...
                            @if (Auth::user()->canAdmin())
                                <a style="font-family: 'Oswald'" href="javascript:void(0)" data-toggle="modal"
                                    data-target="#add-session-modal"
                                    class="btn btn-info m-b-5 m-l-15 addSessionButton"><i
                                        class="fa fa-plus-circle"></i> Book a Session</a>
                                <a style="font-family: 'Oswald'" href="javascript:void(0)" data-toggle="modal"
                                    data-target="#add-patient-modal" class="btn btn-info m-b-5 m-l-15"><i
                            ...
                            <a style="font-family: 'Oswald'" href="javascript:void(0)" data-toggle="modal"
                                data-target="#day-note" class="btn btn-info m-b-5 m-l-15"><i
                                    class="fa fa-plus-circle"></i> Day Note </a>
                            <a style="font-family: 'Oswald'" href="javascript:void(0)" data-toggle="modal"
                                data-target="#add-attendance" class="btn btn-info m-b-5 m-l-15"><i
                ...
                <!-- ADD NEW PATIENT -->
                <!-- ============================================================== -->
                <div id="add-payment-modal" class="modal fade" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        <select class="form-control  col-md-12 mb-3" style="width:100%"
                                            id=accountModal>
                                ...
                                <div class="form-group">
                                    <label>Title*</label>
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control" placeholder="Transaction Title"
                                            id=titleModal required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label>In*</label>
                                    <div class="input-group mb-3">
                                        <input type="number" step=0.01 class="form-control" placeholder="In Amount"
                                            id=inModal value="0" required>
                                    </div>
                                ...
                                <div class="form-group">
                                    <label>Out*</label>
                                    <div class="input-group mb-3">
                                        <input type="number" step=0.01 class="form-control" placeholder="Out Amount"
                                            id=outModal value="0" required>
                                    </div>
                                ...
                                <button type="button" onclick="addPayment(true)"
                                    class="btn btn-success mr-2">Add</button>
                ...
                <div id="add-patient-modal" class="modal fade" tabindex="-1" role="dialog"
                    aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    <label>Name*</label>
                                    <div class="input-group mb-3">
                                        <input type="text" id="patientNameModal" class="form-control"
                                ...
                                <div class="form-group">
                                    <label>Mobile*</label>
                                    <div class="input-group mb-3">
                                        <input type="text" id="patientMobnModal" class="form-control"
                                            placeholder="Patient Mobile Number" name=mobn required>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="select form-control  col-md-12 mb-3 " style="width:100%"
                                        id=listIDModal @if (!Auth::user()->isOwner()) readonly @endif>
                                        @foreach ($allPricelists as $key => $list)
                                            <option value="{{ $list->id }}"
                                                @if (!Auth::user()->isOwner() && $key != count($allPricelists) - 1) disabled
                                            @else selected @endif>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="select2 form-control  col-md-12 mb-3 modalSelect2"
                                        style="width:100%" id=channelIDModal>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="select2 form-control  col-md-12 mb-3 modalSelect2"
                                        style="width:100%" id=locationIDModal>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text" id="promoModal" class="form-control"
                                            placeholder="Promocode" name=promo required>
                                    </div>
                                ...
                                @if (Auth::user()->isOwner())
                                    <div class="form-group">
                                        <label>Balance*</label>
                                        <div class="input-group mb-3">
                                            <input type="number" id="patientBlncModal" step=0.01
                                                class="form-control" placeholder="Patient Balance" name=balance
                                                value="0" required>
                                        </div>
                                        <small class="text-muted">In case patient owes us or we owe him money, default
                                            is 0</small>
                                ...
                                <button type="button" onclick="addNewPatient(true)" class="btn btn-success mr-2">Add
                                    Patient</button>
                ...
                <div id="add-attendance" class="modal fade" tabindex="-1" role="dialog"
                    aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                            ...
                            <div class="modal-body">
                                ...
                                @else
                                    <div class="form-group">
                                        <label>Doctor</label>
                                        <select class="select2 form-control  col-md-12 mb-3 modalSelect2"
                                            style="width:100%" id="attendanceModalDoctor">
                                            @foreach ($doctors as $doctor)
                                                <option value="{{ $doctor->id }}"> {{ $doctor->DASH_USNM }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="form-group" style="display: block">
                                    <label>Shifts</label>
                                    <div class="input-group mb-3">
                                        <input type="number" min=0 max=2 step=1 placeholder="1 Or 2 Shifts" value=1
                                            class="form-control" id=numberOfShiftsModal>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label>Date</label>
                                    <div class="input-group mb-3">
                                        <input type="date" value="{{ date('Y-m-d') }}" id="attendanceModalDate"
                                            class="form-control" placeholder="Attendance Date" required>
                                    </div>
                                </div>
                                ...
                                <button type="button" onclick="addAttendance()" class="btn btn-success mr-2">Add
                                    Attendance</button>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    <label>User</label>
                                    <select class="select2 form-control  col-md-12 mb-3 modalSelect2"
                                        style="width:100%" id="msgModalUser">
                                ...
                                <button type="button" onclick="sendMessage()" class="btn btn-success mr-2">Send
                                    Message</button>
                ...
                <div id="day-note" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    <label>Room</label>
                                    <select class="select2 form-control  col-md-12 mb-3 modalSelect2"
                                        style="width:100%" id="dayNoteRoom">
                                ...
                                <div class=row>
                                    <div class=col-4>
                                        <button type="button" onclick="setNote()" class="btn btn-success mr-2">Save
                                            Note</button>
                                    </div>
                                    <div class=col-3>
                                        <button style="display: none" id="deleteNoteBtn" type="button"
                                            onclick="deleteNote()" class="btn btn-danger mr-2">Delete</button>
                                    </div>
                                </div>
                ...
                <!-- ADD NEW SESSION -->
                <!-- ============================================================== -->
                <div id="add-session-modal" class="modal fade" tabindex="-1" role="dialog"
                    aria-labelledby="myModalLabel" aria-hidden="true" style="display: none; ">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="date" id="sessionDate" class="form-control"
                                            placeholder="Session Day" name=sessionDate
                                            onchange="loadAvailableDoctors()" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="time" id="sessionStartTime" class="form-control"
                                            placeholder="Session Start Time" name=sessionStartTime
                                            onchange="loadAvailableDoctors();checkModalEndTime()" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="time" id="sessionEndTime" class="form-control"
                                            placeholder="Session End Time" name=sessionEndTime
                                            onchange="loadAvailableDoctors()" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 form-group">
                                    <label>Room</label>
                                    <select class="select2 form-control  col-md-12 mb-3" style="width:100%"
                                        id=sessionRoom onchange="loadAvailableDoctors()">
                                        @foreach ($rooms as $r)
                                            <option value="{{ $r->id }}"> {{ $r->branch->BRCH_NAME }} -
                                                {{ $r->ROOM_NAME }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group col-md-12 m-t-0">
                                    <h5>Patients</h5>
                                    <select class="select2 form-control modalSelect2" style="width:100%"
                                        name=patientID id=patientSel>
                                    </select>
                                </div>

                                <div class="form-group col-md-12 m-t-0">
                                    <h5 id=doctorsLabel>Doctors</h5>
                                    <select class="select2 form-control modalSelect2" style="width:100%" name=doctorID
                                        id=doctorsSel>
                                    </select>
                                </div>
                                    ...
                                    <div class="row ">
                                        <div class="mb-10 col-3 ">
                                            <button type="button" class="btn btn-success"
                                                onclick="addModalService()">Add</button>
                                        </div>
                                        <div class="ml-10 col-9 d-flex justify-content-end">
                                            <div class="bt-switch">
                                                <div>
                                                    <input type="checkbox" data-size="small" data-on-color="success"
                                                        data-off-color="danger" data-on-text="Commission"
                                                        data-off-text="No Commission" checked id="isCommission">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <button type="button" onclick="addNewSession()" class="btn btn-success mr-2">Add
                                    Session</button>
        ...
        async function checkModalEndTime(rid) {
            ...
            if (servicesIDs.length > 0) {
                await $.ajax({
                    ...
                    let end_time_date = addMinutes((new Date()).setHours(start_time_array[0], start_time_array[
                        1]), data)

                    $('#sessionEndTime').val(end_time_date.getHours().toString().padStart(2, '0') + ":" +
                        end_time_date.getMinutes().toString().padStart(2, '0'))
                })
            }
        }
