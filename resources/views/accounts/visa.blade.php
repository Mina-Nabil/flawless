...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Visa Account</h4>
                <h6 class="card-subtitle">Check out all transactions and visa entries </h6>
                <!-- Nav tabs -->
                <div class="vtabs">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form class="form pt-3" method="post" action="{{ url($formURL) }}" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    <label>In*</label>
                                                    <div class="input-group mb-3">
                                                        <input type="number" step=0.01 class="form-control" placeholder="Visa In Amount" name=in value="0" required>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    <label>Out*</label>
                                                    <div class="input-group mb-3">
                                                        <input type="number" step=0.01 class="form-control" placeholder="Visa Out Amount" name=out value="0" required>
                                                    </div>
