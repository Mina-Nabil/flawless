...
@section('content')
                                ...
                                @foreach ($items as $item)
                                    <tr>
                                        ...
                                        @endswitch
                                                ...
                                                @if ($canCall) href="javascript:void(0)" data-toggle="modal" data-target="#set-status-modal"
                                        data-id="{{ $item->id }}"
                                        @else
                                        disabled @endif>{{ $item->FLUP_STTS }}
                                            </button>
                                        ...
                                        <td>
                                            <button type="button" style="padding:.1rem" class="btn btn-secondary"
                                                ...
                                                data-content="{{ $item->FLUP_TEXT }}" data-original-title="Comment">
                                                <div style="display: none">{{ $item->FLUP_TEXT }}
                                                </div><i class="far fa-list-alt"></i>
                                            </button>
                                        </td>
                                    </tr>
                                @endforeach
    ...
    @if ($canCall)
        <div id="set-status-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="bt-switch">
                                <div>
                                    <input type="checkbox" data-size="large" data-on-color="success" data-off-color="danger"
                                        data-on-text="Yes" id="isSatisfied" data-off-text="No" name="isCommission"
