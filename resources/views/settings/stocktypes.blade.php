                ...
                <form class="form pt-3" method="post" action="{{ url($formURL) }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" placeholder="Typename" name=name aria-label="Typename" aria-describedby="basic-addon11"
                                value="{{ (isset($type)) ? $type->STTP_NAME : old('name')}}" required>
                        </div>
